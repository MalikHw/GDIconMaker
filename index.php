                ...
                <div class="tutorial-content" id="tutorialContent">
                    ...
                    <div class="tutorial-section">
                        ...
                        <ol>
                            ...
                            <li><strong>THAT'S IT!</strong> (make sure to set col1 to white, if you don't want then install <a href="https://geode-sdk.org/mods/rooot.custom-gamemode-colors" target="_blank">this fuck</a>)</li>
                        </ol>
                    </div>
            ...
            <form id="iconForm" enctype="multipart/form-data">
                <div class="upload-section">
                    <div class="upload-label" id="dropZone">
                        ...
                        <span>drop ur pics here or click (max 400 pics)</span>
                        <input type="file" id="iconImage" name="iconImage[]" accept="image/*" multiple required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="pack-icon-upload">
                        ...
                        <div id="packIconPreview" style="display:none;">
                            ...
                            <button type="button" id="removePackIcon" class="remove-pack-icon">×</button>
                        </div>
                    </div>
                </div>

                <div class="form-group">
                    <label><i class="nf nf-fa-circle"></i> ball mode:</label>
                    <div class="ball-options">
                        <label class="ball-checkbox">
                            <input type="checkbox" id="noBall" name="noBall">
                            <span>dont do ball</span>
                        </label>
                        <label class="ball-checkbox">
                            <input type="checkbox" id="ballOnly" name="ballOnly">
                            <span>ball only</span>
                        </label>
                    </div>
                </div>
